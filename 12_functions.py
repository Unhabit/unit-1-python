...
def average(numbers):  # This function takes a list of numbers and returns the average (mean) of those numbers.
    """
    This function takes a list of numbers and returns the average (mean) of those numbers.
    """
...
def calculate_total(price, quantity, discount=0):  # This function takes price and quantity, and optionally a discount.
    """
    This function takes price and quantity, and optionally a discount.
    It calculates the total by multiplying price and quantity, and applies the discount if provided.
    """
